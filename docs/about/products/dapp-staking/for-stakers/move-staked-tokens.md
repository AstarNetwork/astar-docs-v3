...
- If you move tokens from a dApp and your staked tokens are less than the [minimum staking] (/docs/about/products/dapp-staking/#parameters) amount for a dApp, all your tokens will be `unstaked` from that dApp;  **LINK TO UPDATE**
