...
Ensure you have a non-zero balance of the native token as described in [this section](https://docs.astar.network/docs/build/build-on-layer-1/smart-contracts/building-cross-chain-contracts/xcm/using-xcm/xcm-transactions).
