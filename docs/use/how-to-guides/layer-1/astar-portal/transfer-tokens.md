...
a. If you are on Astar EVM, insert the destination address. You will need to use the [origin chain’s address](/docs/build/build-on-layer-1/smart-contracts/building-cross-chain-contracts/faq.md#q-where-can-i-find-other-chains-addresses).
