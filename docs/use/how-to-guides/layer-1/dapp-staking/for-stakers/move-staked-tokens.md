...
- If you move tokens from a dApp and your staked tokens are less than the [minimum staking](/docs/about/dapp-staking/index.md#parameters) amount for a dApp, all your tokens will be `unstaked` from that dApp;
