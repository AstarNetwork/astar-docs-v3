...
[More information about dApp Staking](/docs/about/dapp-staking/index.md).

If you have `ASTR` on Astar L1 (Subtrate or EVM), consult [this guide](/docs/use/how-to-guides/layer-2/bridge/Bridge-Astar-EVM.md) to transfer them from Astar to Astar zkEVM.
