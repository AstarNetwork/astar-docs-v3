...
You can read more about Proxy accounts [here](/docs/use/how-to-guides/layer-1/manage-wallets/setup-proxy.md).
...
## Learn more
[Create a Substrate account](/docs/use/how-to-guides/layer-1/manage-wallets/create-wallet.md)

[Create an EVM account](/docs/use/how-to-guides/layer-1/evm-guides/setup-metamask.md)
